				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
							<a href="index.html">
								<img class="img-fluid" src="{{asset('assets/megazine/img/logo.png')}}" alt="">
							</a>
						</div>
						<div class="col-lg-8 col-md-8 col-sm-12 logo-right no-padding ads-banner">
							<img class="img-fluid" src="{{asset('assets/megazine/img/banner-ad.jpg')}}" alt="">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row feedback-contents justify-content-between align-items-center">
					...
					<div class="col-lg-5 feedback-right relative d-flex justify-content-center align-items-center">
						...
						<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid" src="{{asset('assets/megazine/img/play-btn.png')}}" alt=""></a>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="active-testimonial">
						<div class="single-testimonial item d-flex flex-row">
							<div class="thumb">
								<img class="img-fluid" src="{{asset('assets/megazine/img/about/user1.png')}}" alt="">
							</div>
							<div class="desc">
								<p>
						...
						<div class="single-testimonial item d-flex flex-row">
							<div class="thumb">
								<img class="img-fluid" src="{{asset('assets/megazine/img/about/user2.png')}}" alt="">
							</div>
							<div class="desc">
								<p>
				...
				<div class="brand-wrap">
					<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="{{asset('assets/megazine/img/l1.png')}}" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="{{asset('assets/megazine/img/l2.png')}}" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="{{asset('assets/megazine/img/l3.png')}}" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="{{asset('assets/megazine/img/l4.png')}}" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="{{asset('assets/megazine/img/l5.png')}}" alt=""></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 single-footer-widget">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="{{asset('assets/megazine/img/i1.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i2.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i3.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i4.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i5.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i6.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i7.jpg')}}" alt=""></li>
							<li><img src="{{asset('assets/megazine/img/i8.jpg')}}" alt=""></li>
						</ul>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
		...
		<!-- End footer Area -->
		<script src="{{asset('assets/megazine/js/vendor/jquery-2.2.4.min.js')}}"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
		<script src="{{asset('assets/megazine/js/vendor/bootstrap.min.js')}}"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
		<script src="{{asset('assets/megazine/js/easing.min.js')}}"></script>
		<script src="{{asset('assets/megazine/js/hoverIntent.js')}}"></script>
		<script src="{{asset('assets/megazine/js/superfish.min.js')}}"></script>
		<script src="{{asset('assets/megazine/js/jquery.ajaxchimp.min.js')}}"></script>
		<script src="{{asset('assets/megazine/js/jquery.magnific-popup.min.js')}}"></script>
		<script src="{{asset('assets/megazine/js/mn-accordion.js')}}"></script>
		<script src="{{asset('assets/megazine/js/jquery-ui.js')}}"></script>
		<script src="{{asset('assets/megazine/js/jquery.nice-select.min.js')}}"></script>
		<script src="{{asset('assets/megazine/js/owl.carousel.min.js')}}"></script>
		<script src="{{asset('assets/megazine/js/mail-script.js')}}"></script>
		<script src="{{asset('assets/megazine/js/main.js')}}"></script>
	</body>
</html>
							...
							<div class="latest-post-wrap">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											...
											<img class="img-fluid" src="{{ asset('assets/magazine/img/l1.jpg') }}" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="{{ asset('assets/magazine/img/l2.jpg') }}" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="{{ asset('assets/magazine/img/l3.jpg') }}" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="{{ asset('assets/magazine/img/l4.jpg') }}" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="{{ asset('assets/magazine/img/r1.jpg') }}" alt="">
										</div>
										<ul class="tags">
											<li><a href="#">Science</a></li>
										</ul>
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="{{ asset('assets/magazine/img/r2.jpg') }}" alt="">
										</div>
										<ul class="tags">
											<li><a href="#">Travel</a></li>
										</ul>
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="{{ asset('assets/magazine/img/r3.jpg') }}" alt="">
										</div>
										<ul class="tags">
											<li><a href="#">Fashion</a></li>
										</ul>
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="{{asset('as sets/magazine/img/sidebar-ads.jpg') }}" alt="">
								</div>

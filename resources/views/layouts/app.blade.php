...
<head>
    ...
    <script src ="{{ asset('assets/frontend/select2-4.0.7/dist/js/select2.min.js')}}"></script>
    ...
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
     ...
     <link href="{{ asset('assets/frontend/select2-4.0.7/dist/css/select2.min.css') }}" rel="stylesheet">
